<template>
    ...
    <div class="fade-inn-transition mr-2">
        ...
        <div v-for="item in list" v-bind:key="item.id" class="float-right p-5">
            <div id="card-bot">
                <!--  v-bind lets you bind an HTML attribute to a JavaScript expression, like binding href to a api call-->
                <a v-bind:href="`https://github.com/` +item.full_name" class="text-decoration-none stretched-link">
                    <div id="card-bot-img">
